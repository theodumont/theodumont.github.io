...
- :bar_chart:&nbsp; @ Mines Paris: **Sciences des données** *(Data science)* -- Year 3, teaching assistant ([link](https://git.sophia.minesparis.psl.eu/chloe-agathe.azencott/sdd_2026))
...
- :bar_chart:&nbsp; @ Univ. Gustave Eiffel: **Machine learning** *(Machine learning)* -- Year 4, teaching assistant
- :bar_chart:&nbsp; @ Mines Paris: **Sciences des données** *(Data science)* -- Year 3, teaching assistant ([link](https://github.com/chagaz/sdd_2025))
